        ...
        case SPELLFAMILY_GENERIC:
        {
            switch(m_spellInfo->Id)
            {
                ...
                case 24745:
                    ...
                    {
                        case 0:
                            m_caster->SummonCreature(15307, m_caster->GetPositionX(), m_caster->GetPositionY(), m_caster->GetPositionZ(), m_caster->GetOrientation(), TEMPSUMMON_DEAD_DESPAWN, -1);
                            break;
                        case 1:
                            m_caster->SummonCreature(15209, m_caster->GetPositionX(), m_caster->GetPositionY(), m_caster->GetPositionZ(), m_caster->GetOrientation(), TEMPSUMMON_DEAD_DESPAWN, -1);
                            break;
                        case 2:
                            m_caster->SummonCreature(15212, m_caster->GetPositionX(), m_caster->GetPositionY(), m_caster->GetPositionZ(), m_caster->GetOrientation(), TEMPSUMMON_DEAD_DESPAWN, -1);
                            break;
                        case 3:
                            m_caster->SummonCreature(15211, m_caster->GetPositionX(), m_caster->GetPositionY(), m_caster->GetPositionZ(), m_caster->GetOrientation(), TEMPSUMMON_DEAD_DESPAWN, -1);
                            break;
                    }
                ...
                case 24762:
                    ...
                    {
                        case 0:
                            m_caster->SummonCreature(15206, m_caster->GetPositionX(), m_caster->GetPositionY(), m_caster->GetPositionZ(), m_caster->GetOrientation(), TEMPSUMMON_DEAD_DESPAWN, -1);
                            break;
                        case 1:
                            m_caster->SummonCreature(15207, m_caster->GetPositionX(), m_caster->GetPositionY(), m_caster->GetPositionZ(), m_caster->GetOrientation(), TEMPSUMMON_DEAD_DESPAWN, -1);
                            break;
                        case 2:
                            m_caster->SummonCreature(15208, m_caster->GetPositionX(), m_caster->GetPositionY(), m_caster->GetPositionZ(), m_caster->GetOrientation(), TEMPSUMMON_DEAD_DESPAWN, -1);
                            break;
                        case 3:
                            m_caster->SummonCreature(15220, m_caster->GetPositionX(), m_caster->GetPositionY(), m_caster->GetPositionZ(), m_caster->GetOrientation(), TEMPSUMMON_DEAD_DESPAWN, -1);
                            break;
                    }
                ...
                case 24785:
                    ...
                    {
                        case 0:
                            m_caster->SummonCreature(15305, m_caster->GetPositionX(), m_caster->GetPositionY(), m_caster->GetPositionZ(), m_caster->GetOrientation(), TEMPSUMMON_DEAD_DESPAWN, -1);
                            break;
                        case 1:
                            m_caster->SummonCreature(15203, m_caster->GetPositionX(), m_caster->GetPositionY(), m_caster->GetPositionZ(), m_caster->GetOrientation(), TEMPSUMMON_DEAD_DESPAWN, -1);
                            break;
                        case 2:
                            m_caster->SummonCreature(15205, m_caster->GetPositionX(), m_caster->GetPositionY(), m_caster->GetPositionZ(), m_caster->GetOrientation(), TEMPSUMMON_DEAD_DESPAWN, -1);
                            break;
                        case 3:
                            m_caster->SummonCreature(15204, m_caster->GetPositionX(), m_caster->GetPositionY(), m_caster->GetPositionZ(), m_caster->GetOrientation(), TEMPSUMMON_DEAD_DESPAWN, -1);
                            break;
                    }
                // Summon Templars
                case 24759:
