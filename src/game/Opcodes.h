...
enum Opcodes
{
    ...
    SMSG_RWHOIS                                     = 0x1FE,
    MSG_LOOKING_FOR_GROUP                           = 0x1FF, // uint32, uint8, uint32, uint32, uint32, uint32, uint32, uint8, for(uint8) {uint32,uint32,uint32}
    ...
    SMSG_UNKNOWN_1211                               = 0x4BB, // SMSG, calendar related EVENT_CALENDAR_ACTION_PENDING
    ...
    SMSG_UNKNOWN_1223                               = 0x4C7, // uint64, EVENT_ARENA_OPPONENT_UPDATE
    ...
    SMSG_UNKNOWN_1246                               = 0x4DE, // uint32, EVENT_BATTLEFIELD_MGR_ENTRY_INVITE
    CMSG_UNKNOWN_1247                               = 0x4DF, // lua: BattlefieldMgrEntryInviteResponse
    SMSG_UNKNOWN_1248                               = 0x4E0, // uint32, uint8, uint8 EVENT_BATTLEFIELD_MGR_ENTERED
    SMSG_UNKNOWN_1249                               = 0x4E1, // uint32 EVENT_BATTLEFIELD_MGR_QUEUE_INVITE
    CMSG_UNKNOWN_1250                               = 0x4E2, // lua: BattlefieldMgrQueueInviteResponse
    CMSG_UNKNOWN_1251                               = 0x4E3, // lua: BattlefieldMgrQueueRequest
    SMSG_UNKNOWN_1252                               = 0x4E4, // uint32, uint8 EVENT_BATTLEFIELD_MGR_QUEUE_REQUEST_RESPONSE
    SMSG_UNKNOWN_1253                               = 0x4E5, // uint32 EVENT_BATTLEFIELD_MGR_EJECT_PENDING
    SMSG_UNKNOWN_1254                               = 0x4E6, // uint32, uint32, uint8 EVENT_BATTLEFIELD_MGR_EJECTED
    CMSG_UNKNOWN_1255                               = 0x4E7, // lua: BattlefieldMgrExitRequest
    SMSG_UNKNOWN_1256                               = 0x4E8, // uint32, uint32 EVENT_BATTLEFIELD_MGR_STATE_CHANGE
    ...
    SMSG_UNKNOWN_1274                               = 0x4FA, // uint8 EVENT_TALENTS_INVOLUNTARILY_RESET
