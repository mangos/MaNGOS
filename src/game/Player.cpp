...
bool Player::BuildEnumData(QueryResult* result, ByteBuffer* p_data)
{
    ...
    uint8 GuidBytes[8] = { 0, 4, 6, 2, 5, 7, 1, 3 };
    uint8 GuildGuidBytes[8] = { 0, 5, 6, 3, 2, 7, 4, 1 };
    ...
    p_data->WriteGuidBytes(guildGuid, GuildGuidBytes, 1, 0);
    ...
    *p_data << uint32(char_flags);                          // character flags
    ...
    p_data->WriteGuidBytes(guid, GuidBytes, 2, 0);
    p_data->WriteGuidBytes(guildGuid, GuildGuidBytes, 1, 1);
    p_data->WriteGuidBytes(guid, GuidBytes, 2, 2);
    p_data->WriteGuidBytes(guildGuid, GuildGuidBytes, 1, 2);

    *p_data << uint8(playerBytes >> 16);                    // hair style
    *p_data << uint8(pRace);                                // race

    p_data->WriteGuidBytes(guildGuid, GuildGuidBytes, 1, 3);
    p_data->WriteGuidBytes(guid, GuidBytes, 1, 4);
    ...
    *p_data << uint32(petFamily);
    ...
    p_data->WriteGuidBytes(guildGuid, GuildGuidBytes, 1, 4);
    ...
    *p_data << uint32(fields[8].GetUInt32());               // zone
    ...
    p_data->WriteGuidBytes(guildGuid, GuildGuidBytes, 1, 5);
    ...
    *p_data << uint8(fields[4].GetUInt8());                 // gender
    ...
    p_data->WriteGuidBytes(guildGuid, GuildGuidBytes, 1, 6);
    ...
    *p_data << uint8(playerBytes >> 24);                    // hair color
    ...
    p_data->WriteGuidBytes(guildGuid, GuildGuidBytes, 1, 7);
