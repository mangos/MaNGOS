...
enum SpellCastResult
{
    ...
    SPELL_FAILED_NO_CHARGES_REMAIN = 77,
    ...
    SPELL_FAILED_WRONG_PET_FOOD = 136,
    SPELL_FAILED_NOT_WHILE_FATIGUED = 137,
    SPELL_FAILED_TARGET_NOT_IN_INSTANCE = 138,
    SPELL_FAILED_NOT_WHILE_TRADING = 139,
    SPELL_FAILED_TARGET_NOT_IN_RAID = 140,
    SPELL_FAILED_TARGET_FREEFORALL = 141,
    SPELL_FAILED_NO_EDIBLE_CORPSES = 142,
    SPELL_FAILED_ONLY_BATTLEGROUNDS = 143,
    SPELL_FAILED_TARGET_NOT_GHOST = 144,
    SPELL_FAILED_TRANSFORM_UNUSABLE = 145,
    SPELL_FAILED_WRONG_WEATHER = 146,
    SPELL_FAILED_DAMAGE_IMMUNE = 147,
    SPELL_FAILED_PREVENTED_BY_MECHANIC = 148,
    SPELL_FAILED_PLAY_TIME = 149,
    SPELL_FAILED_REPUTATION = 150,
    SPELL_FAILED_MIN_SKILL = 151,
    SPELL_FAILED_NOT_IN_ARENA = 152,
    SPELL_FAILED_NOT_ON_SHAPESHIFT = 153,
    SPELL_FAILED_NOT_ON_STEALTHED = 154,
    SPELL_FAILED_NOT_ON_DAMAGE_IMMUNE = 155,
    SPELL_FAILED_NOT_ON_MOUNTED = 156,
    SPELL_FAILED_TOO_SHALLOW = 157,
    SPELL_FAILED_TARGET_NOT_IN_SANCTUARY = 158,
    SPELL_FAILED_TARGET_IS_TRIVIAL = 159,
    SPELL_FAILED_BM_OR_INVISGOD = 160,
    SPELL_FAILED_EXPERT_RIDING_REQUIREMENT = 161,
    SPELL_FAILED_ARTISAN_RIDING_REQUIREMENT = 162,
    SPELL_FAILED_NOT_IDLE = 163,
    SPELL_FAILED_NOT_INACTIVE = 164,
    SPELL_FAILED_PARTIAL_PLAYTIME = 165,
    SPELL_FAILED_NO_PLAYTIME = 166,
    SPELL_FAILED_NOT_IN_BATTLEGROUND = 167,
    SPELL_FAILED_NOT_IN_RAID_INSTANCE = 168,
    SPELL_FAILED_ONLY_IN_ARENA = 169,
    SPELL_FAILED_TARGET_LOCKED_TO_RAID_INSTANCE = 170,
    SPELL_FAILED_ON_USE_ENCHANT = 171,
    SPELL_FAILED_NOT_ON_GROUND = 172,
    SPELL_FAILED_CUSTOM_ERROR = 173,
    SPELL_FAILED_CANT_DO_THAT_RIGHT_NOW = 174,
...
// will only support WoW, WoW:TBC, WoW:WotLK and WoW:Cataclysm 4.0.0 client build 12803...

#define EXPECTED_MANGOSD_CLIENT_BUILD        {12803, 0}
